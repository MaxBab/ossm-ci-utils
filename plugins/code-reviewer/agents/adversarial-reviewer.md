...
description: |
  ...
  assistant: "I'll dispatch the adversarial-reviewer agent with the full-scope brief."
  <commentary>
  The adversarial reviewer gets the full-scope brief covering all review units.
  </commentary>
  </example>

  <example>
  Context: Single-phase adversarial review
